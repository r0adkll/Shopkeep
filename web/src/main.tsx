...
const router = createRouter({
  routeTree: rootRoute.addChildren([indexRoute, setupRoute, loginRoute, productsRoute, listingsRoute, importEtsyRoute, ordersRoute, statsRoute, settingsRoute, connectionsRoute]),
});
